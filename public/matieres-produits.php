...
<body>
  ...
  <div class="wrapper yellowPage">
        ...
        <div class="pure-u-1">
          <nav class="pure-menu pure-menu-horizontal" id="mainNavigation">
            <ul class="pure-menu-list">
              ...
              <li class="pure-menu-item"><a class="actif" href="matieres-produits.php">Matieres et produits</a></li>
              <li class="pure-menu-item"><a href="#">Nos métiers</a></li>
              <li class="pure-menu-item"><a href="cours-metaux.php">Données économiques</a></li>
    ...
    <div class="breadcrumb">
      <a href="index.php">A3M</a> <a href="#">Adhérents</a>
    </div>
		<div class="sidebar">
			<div class="submenu green">
				<ul>
					...
					<li><a href="#">Présentation du secteur</a></li>
      ...
      <div class="donneesEco">
        ...
        <span class="btn blue fullwidth annuaireAdherents"><a href="#">Annuaire<br/>des adhérents</a></span> 
      </div>
		</div>

      <div class="pageContent">
        <div class="pure-u-1 pure-u-md-1-1 l-box hp-actu">
          <h2 class="titlePAge">Produits et producteurs</h2>
          ...
          <div class="hp2col listeAdherents">
            <div class="col">
              <ul>
                <li><a href="adherent.php">ACCUMULATEURS HUITRIC</a></li>
                <li><a href="adherent.php">AFFINERIE DE PONT SAINTE MAXENCE (APSM)</a></li>
                <li><a href="adherent.php">s.a.s.</a></li>
                <li><a href="adherent.php">ACCUMULATEURS HUITRIC</a></li>
                <li><a href="adherent.php">AFFINERIE DE PONT SAINTE MAXENCE (APSM)</a></li>
                <li><a href="adherent.php">s.a.s.</a></li>
                <li><a href="adherent.php">ACCUMULATEURS HUITRIC</a></li>
            ...
            <div class="col">
              <ul>
                <li><a href="#">ACCUMULATEURS HUITRIC</a></li>
                <li><a href="#">AFFINERIE DE PONT SAINTE MAXENCE (APSM)</a></li>
                <li><a href="#">s.a.s.</a></li>
                <li><a href="#">ACCUMULATEURS HUITRIC</a></li>
                <li><a href="#">AFFINERIE DE PONT SAINTE MAXENCE (APSM)</a></li>
                <li><a href="#">s.a.s.</a></li>
                <li><a href="#">ACCUMULATEURS HUITRIC</a></li>
